...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_timer__WEBPACK_IMPORTED_MODULE_3__["default"])('.container1', '2023-08-16');
...
var forms = function forms() {
  ...
  var message = {
    loading: "Загрузка",
    sucess: "Скоро мы с вами свяжемся",
    ...
    return regeneratorRuntime.async(function postData$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            document.querySelector('.status').textContent = "".concat(message.loading);
            _context.next = 3;
  ...
  form.forEach(function (item) {
    item.addEventListener('submit', function (e) {
      ...
      postData('window/dist/assets/server.php', formData).then(function (res) {
        console.log(res);
